    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rotors', models.CharField(choices=[('3', '3'), ('4', '4'), ('5', '5'), ('6', '6'), ('8', '8')], max_length=10)),
                ('battery', models.CharField(choices=[('2s', '2s'), ('3s', '3s'), ('4s', '4s'), ('5s', '5s'), ('6s', '6s')], max_length=10)),
                ('prop_length', models.IntegerField(max_length=10)),
                ('flight_time_in_minutes', models.IntegerField(max_length=10)),
            ],
            managers=[
                ('Drones', django.db.models.manager.Manager()),
            ],
        ),
    ]
