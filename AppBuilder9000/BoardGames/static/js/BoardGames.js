    ...
    if (parseInt(gameid) && parseInt(gameid) > 0 && gameid.length <= 6) {
        ...
        $.ajax({
            ...
            success: function(xml) {
                ...
                // When .text() finally worked for image, thumbnail, and description, I tried .attr().  No luck.
                // Searching through the parent object I found the attributes node had what I needed.
                ...
                //     It was really helpful for finding the publisher, but I needed to remove the @ sign.
